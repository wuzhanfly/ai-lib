...
type queueMidjourneyDao struct {
	*internal.QueueMidjourneyDao
}

var (
	// QueueMidjourney is globally public accessible object for table c_queue_midjourney operations.
	QueueMidjourney queueMidjourneyDao
)

func init() {
	QueueMidjourney = queueMidjourneyDao{
		internal.NewQueueMidjourneyDao(),
	}
}
