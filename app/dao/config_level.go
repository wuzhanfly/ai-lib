...
type configLevelDao struct {
	*internal.ConfigLevelDao
}

var (
	// ConfigLevel is globally public accessible object for table c_config_level operations.
	ConfigLevel configLevelDao
)

func init() {
	ConfigLevel = configLevelDao{
		internal.NewConfigLevelDao(),
	}
}
