...
type configOpenaiDao struct {
	*internal.ConfigOpenaiDao
}

var (
	// ConfigOpenai is globally public accessible object for table c_config_openai operations.
	ConfigOpenai configOpenaiDao
)

func init() {
	ConfigOpenai = configOpenaiDao{
		internal.NewConfigOpenaiDao(),
	}
}
