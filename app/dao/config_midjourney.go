...
type configMidjourneyDao struct {
	*internal.ConfigMidjourneyDao
}

var (
	// ConfigMidjourney is globally public accessible object for table c_config_midjourney operations.
	ConfigMidjourney configMidjourneyDao
)

func init() {
	ConfigMidjourney = configMidjourneyDao{
		internal.NewConfigMidjourneyDao(),
	}
}
